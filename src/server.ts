...
app.get('/cases.html', (_req, res) => res.sendFile(path.join(UI_DIR, 'cases.html')));
app.get('/anwendungen.html', (_req, res) => res.redirect(301, '/cases.html'));
app.get('/steuerfall.html', (_req, res) => res.sendFile(path.join(UI_DIR, 'steuerfall.html')));
app.get('/assistant.html', (_req, res) => res.sendFile(path.join(UI_DIR, 'assistant.html')));
app.get('/assistant', (_req, res) => res.sendFile(path.join(UI_DIR, 'assistant.html')));
app.get('/orchestrator', (_req, res) => res.redirect(301, '/assistant.html'));
app.get('/orchestrator.html', (_req, res) => res.redirect(301, '/assistant.html'));
