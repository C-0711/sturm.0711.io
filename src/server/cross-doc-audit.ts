...
const PROMPT = (jahr: number | null) => [
  `Steuerassistent. Case-Jahr ${jahr ?? '?'}. Analysiere master.json (folgt unten)`,
  'auf Cross-Doc-Plausibilität. Antworte als JSON:',
  '{"summary":"1-2 Sätze","warnings":[{"severity":"info|warn|error","kategorie":"year|person|duplicate|conflict|missing|consistency","message":"...","betrifft_ecodes":["EXXX"],"betrifft_dokumente":["file.pdf"]}],"year_carryover_ok":[{"ecode":"E","from_jahr":2023,"reason":"Stammdatum/Pauschale"}],"year_carryover_blocked":[{"ecode":"E","from_jahr":2023,"reason":"Jahresgebunden"}],"person_zuordnung":[{"dokument":"file","person":"A|B|unbekannt","begruendung":"..."}],"missing_anlagen":[{"anlage":"X","reason":"..."}]}',
  '',
  'Regeln knapp: Stammdaten + Pauschalen sind jahresübergreifend.',
  'Jahresgebunden: Brutto, Lohnsteuer, KirchSt-AN, KapErträge, Rente, Vorsorge.',
  'IdNr-Match identifiziert Person A; andere IdNr + Ehestand = Person B.',
  'Pflicht-Belege: N→LSt-Besch, KAP→Bank-Besch, R→Rentenbezug, VOR→KV/PV-Besch.',
